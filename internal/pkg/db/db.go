...
// GetContext if a wrapped method pgxscan.Get ...
...
// QuryRowContext is a wrapped method pgxpool.QueryRow ...
func (db *DB) QuryRowContext(ctx context.Context, q Query, args ...interface{}) pgxV4.Row {
